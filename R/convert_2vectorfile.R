#' Reads in CSV files with coordinates and creates polygone shapefiles via raster
#' 
#' Considers only CSV files in the indir. They must have a "x" and "y" column, but not "z"!
#' @param indir 
#' @param outdir
