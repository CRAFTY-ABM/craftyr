...
Craftyr uses the package 'logging' which is based on pyhton logging. Initially, it sets up a console outputter 
...
Compare the documentation for package 'logging' for more detailed information.
...
changes. Crucial is a consistent naming of R objects!
